...
from app.models import PreviewRun, ReportBlock, ReportPage
from app.services.admin_ops import clone_block, validate_block_payload
...
def list_blocks(request: Request, db: Session = Depends(get_db)):
    ...
    return templates.TemplateResponse("admin/blocks.html", {"request": request, "blocks": blocks, "latest_map": latest_map})
